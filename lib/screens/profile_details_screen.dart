            ...
            Expanded(
              ...
              child: Column(
                children: [
                  ...
                  Gap(height*0.05),
                  CustomTextField(label: "First Name", keybordType: TextInputType.name,),
                  Gap(14),
                  CustomTextField(label: "Last Name", keybordType: TextInputType.name),
                  Gap(10),
                  Container(
                    height: height*0.065,
                  ...
                  Gap(10),
                  CustomTextField(label: "Country", keybordType: TextInputType.text,),
                  Gap(10),
                  CustomTextField(label: "State", keybordType: TextInputType.text,),
                  Gap(10),
                  CustomTextField(label: "City", keybordType: TextInputType.text),
                  Gap(10),
                  CustomTextField(label: "Religion", keybordType: TextInputType.text,),
                  Gap(10),
                  CustomTextField(label: "Caste", keybordType: TextInputType.text,),
                  Gap(10),
                  CustomTextField(label: "Email",keybordType: TextInputType.text),
                  const Gap(10),
                  CustomTextField(label: "Mobile",keybordType: TextInputType.number),
                  const Gap(30),
                  CustomButton(
                      title: "Confirm",
                      onclick: () {
